...
<body class="flex flex-col min-h-screen">
  ...
  <header class="bg-white shadow-sm sticky top-0 z-50">
    ...
    <div id="mobile-menu" class="hidden md:hidden bg-white border-t border-gray-100 px-4 pt-2 pb-4 space-y-2 shadow-lg absolute w-full">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="index.html" class="text-gray-600 hover:text-brand">Home</a></li>
            <li><a href="services.html" class="text-gray-600 hover:text-brand">Services</a></li>
            <li><a href="offers.html" class="text-gray-600 hover:text-brand">Offers</a></li>
            <li><a href="about.html" class="text-gray-600 hover:text-brand">About</a></li>
            <li><a href="contact.html" class="text-gray-600 hover:text-brand">Contact</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul class="space-y-2">
            <li><a href="tracking.html" class="text-gray-600 hover:text-brand">Track Order</a></li>
            <li><a href="#" class="text-gray-600 hover:text-brand">How It Works</a></li>
            <li><a href="#" class="text-gray-600 hover:text-brand">Shipping</a></li>
            <li><a href="#" class="text-gray-600 hover:text-brand">FAQ</a></li>
            <li><a href="contact.html" class="text-gray-600 hover:text-brand">Contact Support</a></li>
          </ul>
        </div>
        ...
        <div>
          ...
          <div class="flex space-x-4 mt-6">
            <a href="#" class="text-gray-400 hover:text-brand"><i data-lucide="facebook" class="h-5 w-5"></i></a>
            <a href="#" class="text-gray-400 hover:text-brand"><i data-lucide="instagram" class="h-5 w-5"></i></a>
            <a href="#" class="text-gray-400 hover:text-brand"><i data-lucide="twitter" class="h-5 w-5"></i></a>
          </div>
        </div>
      </div>
    ...
    <section class="py-20 bg-bg">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6 mb-12">
          <div class="bg-white py-8 px-4 rounded-xl shadow-sm text-center font-bold text-xl text-gray-800 flex items-center justify-center h-32 border border-gray-100">SHEIN</div>
          <div class="bg-white py-8 px-4 rounded-xl shadow-sm text-center font-bold text-xl text-orange-500 flex items-center justify-center h-32 border border-gray-100">Alibaba</div>
          <div class="bg-white py-8 px-4 rounded-xl shadow-sm text-center font-bold text-xl text-blue-900 flex items-center justify-center h-32 border border-gray-100">Amazon</div>
          <div class="bg-white py-8 px-4 rounded-xl shadow-sm text-center font-bold text-xl text-red-600 flex items-center justify-center h-32 border border-gray-100">AliExpress</div>
          <div class="bg-white py-8 px-4 rounded-xl shadow-sm text-center font-bold text-xl text-orange-600 flex items-center justify-center h-32 border border-gray-100">Temu</div>
          <div class="bg-white py-8 px-4 rounded-xl shadow-sm text-center font-bold text-xl text-blue-600 flex items-center justify-center h-32 border border-gray-100">eBay</div>
        </div>
    ...
    <section class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <!-- Service 1 -->
          <div class="border border-gray-100 rounded-2xl p-8 hover:shadow-lg transition bg-bg">
            <i data-lucide="shopping-bag" class="h-10 w-10 text-accent mb-6"></i>
          ...
          <!-- Service 2 -->
          <div class="border border-gray-100 rounded-2xl p-8 hover:shadow-lg transition bg-bg">
            <i data-lucide="plane-takeoff" class="h-10 w-10 text-accent mb-6"></i>
          ...
          <!-- Service 3 -->
          <div class="border border-gray-100 rounded-2xl p-8 hover:shadow-lg transition bg-bg">
            <i data-lucide="search" class="h-10 w-10 text-accent mb-6"></i>
          ...
          <!-- Service 4 -->
          <div class="border border-gray-100 rounded-2xl p-8 hover:shadow-lg transition bg-bg">
            <i data-lucide="shirt" class="h-10 w-10 text-accent mb-6"></i>
          ...
          <!-- Service 5 -->
          <div class="border border-gray-100 rounded-2xl p-8 hover:shadow-lg transition bg-bg">
            <i data-lucide="boxes" class="h-10 w-10 text-accent mb-6"></i>
          ...
          <!-- Service 6 -->
          <div class="border border-gray-100 rounded-2xl p-8 hover:shadow-lg transition bg-bg">
            <i data-lucide="truck" class="h-10 w-10 text-accent mb-6"></i>
    ...
    <section class="py-20 bg-bg">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <!-- Offer Card 1 -->
          <div class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 relative">
          ...
          <!-- Offer Card 2 -->
          <div class="bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-200 relative border-accent border-2">
    ...
    <section class="py-16 bg-white">
      <div class="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <form class="flex flex-col sm:flex-row gap-4 justify-center" onsubmit="event.preventDefault(); document.getElementById('tracking-result').classList.remove('hidden');">
          <input type="text" placeholder="Enter tracking number (e.g., GO-123456)" class="flex-grow max-w-md px-6 py-4 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand focus:border-transparent text-lg" required>
    ...
    <section class="py-20 bg-white">
      <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        ...
        <div class="flex flex-col md:flex-row items-center justify-center gap-4 md:gap-8 max-w-5xl mx-auto">
          <div class="flex-1 bg-bg p-6 rounded-xl border border-gray-200 w-full">
          ...
          <div class="flex-1 bg-accent/10 p-6 rounded-xl border border-accent/20 w-full">
            ...
            <form onsubmit="event.preventDefault(); alert('Message sent!');">
              <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                <div>
                  ...
                  <input type="text" class="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand" required>
                </div>
                <div>
                  <label class="block text-sm font-medium text-gray-700 mb-2">Phone Number</label>
                  <input type="tel" class="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand" required>
                </div>
              </div>
              
              <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-2">Email Address</label>
                <input type="email" class="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand" required>
              </div>
              
              <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-2">Subject (or Product Link)</label>
                <input type="text" class="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand" placeholder="Paste your product link here...">
              </div>
              
              <div class="mb-6">
                <label class="block text-sm font-medium text-gray-700 mb-2">Message</label>
                <textarea rows="4" class="w-full px-4 py-3 rounded-md border border-gray-300 focus:outline-none focus:ring-2 focus:ring-brand"></textarea>
              </div>
...
for filename, data in pages.items():
    html_content = header.format(
        title=data["title"],
        nav_home="active" if data["nav"] == "nav_home" else "",
        nav_services="active" if data["nav"] == "nav_services" else "",
        nav_offers="active" if data["nav"] == "nav_offers" else "",
        nav_about="active" if data["nav"] == "nav_about" else "",
        nav_contact="active" if data["nav"] == "nav_contact" else ""
    ) + data["content"] + footer
    
    with open(os.path.join(r"C:\\Users\\shang\\Desktop\\Order Center", filename), "w", encoding="utf-8") as f:
        f.write(html_content)

print("Created 6 pages successfully.")
